            ...
            .addFields(
                {
                    ...
                    value: [
                        ...
                        "`!prefer [regions]` — server region order (e.g. mtl sf ny uk)",
                        "`!sub <@out> <@in>` — Fort sub (replace no-show)",
                        "`!servers` — live pickup servers with players",
                    ].join("\n"),
                    inline: false,
                },
                {
        ...
        try {
            ...
            await message.channel.send(
                [
                    ...
                    "Queue: !add <mode> / !remove [mode] / !who / !me / !servers",
